...
describe ItemCache do
  ...
  describe '#update' do
    it "should send a PUT request to base_uri/feeds/:feed_id to update a feed"
    it "should send a PUT request to base_uri/feed_items/:feed_item_id to update a feed item"
  end
  
  describe '#delete' do
    it "should send a DELETE request to base_uri/feeds/:feed_id to delete a feed"
    it "should send a DELETE request to base_uri/feed_items/:feed_item_id to delete a feed item"
  end
end
